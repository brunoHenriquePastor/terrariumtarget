...
RUN apt install python3-dev python3-pip && python3 -m pip install --upgrade pip setuptools wheel && pip3 install Adafruit_DHT
WORKDIR /app
...
#python3 -m pip install --upgrade pip setuptools wheel && pip3 install Adafruit_DHT